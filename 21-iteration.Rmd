...
``` {r 21.5.3}
# map(1:5, runif) creates a list of length five that includes the outputs of the respective inputs. 

# map(list(1:5), runif) creates a list of length one that only includes one output. # ??????
